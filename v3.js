...
async function calculate() {
    ...
    document.getElementById('progress').innerHTML = 'Berechnung läuft...'
    ...
    for(let i=0; i<destinations.length; i++){
        ...
        if(i != 0){
            ...
            let route2;
            document.getElementById('progress').innerHTML = ('Berechne Route ' + destinations[i-1] + ' nach ' + destinations[i] + '...')
            ...
            for(let j = 0; j<content.length; j++){
                ...
                route2 += ('<td><h3>' + trainname + '</h3>Von ' + citydeparture + '<br>Abfahrt am ' + timedeparture[0] + ' um ' + timedeparture[1].slice(0,5) + '<br>Nach ' + cityarrival + '<br>Ankunft am ' + timearrival[0] + ' um ' + timearrival[1].slice(0,5) + '<br>Fahrzeit: ' + fahrzeit + '</td>')
            }
